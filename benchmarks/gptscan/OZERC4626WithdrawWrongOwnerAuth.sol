...
Note: ERC4626/Vault-style withdraw/redeem cropped and mutated: wrong_owner.
...
contract OZERC4626WithdrawWrongOwnerAuth {
    ...
    function withdrawFrom(address owner, address receiver, uint256 amount) external {
        require(allowance[msg.sender][owner] >= amount, "allowance-direction-wrong");require(shares[owner] >= amount, "shares");
